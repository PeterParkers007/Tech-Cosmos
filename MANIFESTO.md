...
### 2. 工具优先法则
在开始建造之前，先锻造完美的工具。我们最重要的产品不是最终的游戏，而是那套**不可见的、可复用的生产体系**。**[Tech-Cosmos Hub](https://github.com/PeterParkers007/Tech-Cosmos.git?path=/Tech-Cosmos.Hub)** 即是这套体系在 Unity 编辑器中的统一入口。真正的力量在于构建“创造工具的工具”。
