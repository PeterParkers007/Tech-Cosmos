...
*   **[SkillSystem](https://github.com/PeterParkers007/Tech-Cosmos.Framework.SkillSystem.git)** - **技能框架**
    - **核心价值**：六层分离的工业化技能架构,通过数据驱动设计将复杂技能逻辑拆解为可独立配置的原子层,实现技能系统的无限扩展与维护

*   **[GBF - BuffSystem](https://github.com/PeterParkers007/Tech-Cosmos.Framework.BuffSystem.git)** - **Buff框架**
    - **核心价值**：新增BuffEffectExcuter概念由具体效果和执行模式组成,将Buff定义为管理BuffEffectExcuter的容器,声明式的乐高设计
...
*   **[AI-OS](https://github.com/PeterParkers007/TechCosmos.Component.AI-OS.git)** - **人工智能操作系统**
